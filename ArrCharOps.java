...
public class ArrCharOps {
    ...
    public static int lastIndexOf(char[] arr, char ch) {
        int firstOccurrenceIndex = indexOf(arr, ch);
        if(firstOccurrenceIndex != -1) {
            int lastOccurrenceIndex = indexOf(arr, ch, firstOccurrenceIndex + 1);
            int previousIndex = firstOccurrenceIndex;
            while (lastOccurrenceIndex != -1) {
                previousIndex = lastOccurrenceIndex;
                lastOccurrenceIndex = indexOf(arr, ch, previousIndex + 1);
            }
    ...
    */
    public static char[] concat(char[] arr1, char[] arr2) {
        char[] concatenationArr = new char[arr1.length + arr2.length];
    
        for (int i = 0; i < arr1.length; i++) {
            concatenationArr[i] = arr1[i];
        }
        
        for (int i = 0; i < arr2.length; i++) {
            concatenationArr[arr1.length + i] = arr2[i];
        }
